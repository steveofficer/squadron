...
Added first bullet in `## 2. Research the Codebase` of `agents/backend-engineer.agent.md`: load project-stacks/SKILL.md and each listed stack skill file for technology context.
